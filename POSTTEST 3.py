...
def kasir():
    Coklat = int(input("Kue coklat yang dibeli : "))
    beli_kue_coklat(Coklat)
    print('=' * 20)
    Keju = int(input("Kue keju yang dibeli : "))
    beli_kue_keju(Keju)
    print('=' * 20)
...
def Persediaan():
    print("kue coklat yang tersedia: ", stok_kue[0])
    print("kue keju yang tersedia: ", stok_kue[1])
    kembali_ke_menu()
